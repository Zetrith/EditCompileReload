...
namespace AsmResolver.DotNet.Cloning
{
    ...
    public partial class MemberCloner
    {
        ...
        public readonly HashSet<TypeDefinition> _typesToClone = new();
        public readonly HashSet<MethodDefinition> _methodsToClone = new();
        public readonly HashSet<FieldDefinition> _fieldsToClone = new();
        public readonly HashSet<PropertyDefinition> _propertiesToClone = new();
        public readonly HashSet<EventDefinition> _eventsToClone = new();
